...
int main(){
    ...
    scanf("%lf", &x);
    float func1 = sub(add(Exponent((int)x) ,Power(x,3)), 2);  //e^x + x^3 − 2
    float func2 = add(mul(x,3), mul(2, Power(x, 2)));  //3x + 2x^2
    float func3 = sub(div(mul(Power(x, 3),4), 5), mul(x, 2));  //4x^3 / 5 - 2x
